...
remotes=(
	...
	'nik-rev https://github.com/nik-rev/helix.git'
	'omentic https://github.com/omentic/helix.git'
...
branches=(
	...
	'12759 nik-rev/determine-comment-tokens'
	'14118 omentic/rainbow-indent-guides'
)
